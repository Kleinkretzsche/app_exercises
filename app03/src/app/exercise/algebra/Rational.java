 ...
 * @version 1.0f
 */
public class Rational extends BasisFraction implements Comparable<Rational> {
     ...
     * @throws ArithmeticException don't divide by zero!
     */
    private void normalize() {
	if (d == 0)
	    throw new ArithmeticException("deine mudder");
    ...
    public int compareTo(Rational r) {
        ...
        Double tv = (double) this.n / (double) this.d;
        Double cv = (double) r.n / (double) r.d;
        return tv.compareTo(cv);
    }
}
